    ...
    const fetchListings = async () => {
      try {
        ...
        const uniqueCservice = [
          ...new Set(data.map((listing) => listing.cateringType)),
        ];
    ...
    <div>
      <div className="flex gap-8 flex-wrap my-[10vh]">
        ...
        <div>
          <label
            htmlFor="price"
            className="text-sm font-medium text-gray-700 p-4"
          >
            Price
          </label>
          <select
      ...
      <div className="listings-page flex flex-wrap justify-evenly bg-black">
        {currentListings.length > 0 ? (
          ...
          <p className="col-span-3 text-center text-red-700">
            No listings found
          </p>
        )}
      </div>
      ...
      <ReactPaginate
        ...
        pageClassName={"mx-1"}
        pageLinkClassName={
          "px-4 py-2 border border-gray-300 rounded-full text-gray-700 hover:bg-gray-100"
        }
        previousClassName={"mx-1"}
