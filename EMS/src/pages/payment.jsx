...
//         <div>
//             <div>
//                 <div className='w-[12%]'><img src={easypaisa} className='' alt="" /></div>
//                 <div>
//                     <div><p className='text-xl font-bold text-gray-500'>Select a Payment Method</p></div>
//                     <div className='flex '>
...
//                         </div>
//                         <div><img src={bank} alt="" /></div>
//                     </div>
//                 </div>
//                 <div className='border-2 border-gray-500'>
//                     <div><p className='bg-gray-200 p-1 font-bold text-gray-500'>Instructions</p></div>
//                     <div className='text-gray-400 font-bold text-sm'>
//                         <ul>
//                             <li>please make sure that your bank has enabled your card for internet transactions</li>
//                             <li>Enter your card details correctly</li>
//                             <li>Ensure your card has enough balance and is not expired</li>
//                         </ul>
//                     </div>
//                 </div>
//                 <div className='flex'>
//                     <div>
//                         <label htmlFor="" className='text-gray-500'>Card Number</label>
//                         <input type="text" />
//                     </div>
//                     <div >
//                         <select name="" id="">
...
//                         <input type="text" className='border-gray-900' />
//                     </div>
//                 </div>
//                 <div>
//                     <select name="" id="">
...
//                 </div>
//             </div>
//             <div><p>By clicking "Pay Now", you agree to our Terms &amp; Conditions</p>
//             </div>
//             <button className='bg-green-300 text-white'>Pay Now</button>
//         </div>
//     )
// }
