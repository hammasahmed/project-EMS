...
const Catalog = ({ heading, title, images, descriptions }) => {
  ...
  return (
    <section className="py-16 pb-[300px] bg-gradient-to-r from-[#1a0330] to-[#3a0303] flex flex-col">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center ">
      ...
      <button
        className="mt-2 bg-purple-500 text-white px-4 py-2 rounded-md w-[10%] m-auto "
        onClick={goToAbout}
      >
        Explore More
      </button>
