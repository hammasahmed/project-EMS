...
const Navbar = ({
  ...
  return (
    <div
      className={
        "main sticky top-0 z-10 flex justify-between bg-purple-50 p-1 pb-2 pt-2 h-14"
      }
    >
      <div className="hamburger p-3 sm:hidden" onClick={toggleMenu}>
        <div className="line w-5 h-0.5 m-0.5 bg-black"></div>
      ...
      <div
        ...
        } sm:relative sm:flex sm:top-0 sm:left-auto 
            sm:w-auto sm:flex-row bg-white sm:bg-transparent flex-col sm:flex-row transition-all duration-300 ease-in-out`}
      >
        <ul className="flex flex-col items-center sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3 text-sm md:space-x-10 p-3 sm:p-0">
          <li className="hover:bg-purple-200 p-2 rounded-md tracking-[.05em] hover:translate-y-[2px]">
            <Link to="/">Home</Link>
          </li>
          <li
            className="hover:bg-purple-200 p-2 rounded-md tracking-[.05em] hover:translate-y-[2px]"
            onClick={() => scrollToRef(featuredServicesRef)}
          >
            <Link to="/">Venue</Link>
          </li>
          <li className="hover:bg-purple-200 p-2 rounded-md tracking-[.05em] hover:translate-y-[2px]">
          ...
          <li className="hover:bg-purple-200 p-2 rounded-md tracking-[.05em] hover:translate-y-[2px]"onClick={() => scrollToRef(testimonialRef)}>
          <Link to="/">Reviews</Link>
          </li>
          <li className="hover:bg-purple-200 p-2 rounded-md tracking-[.05em] hover:translate-y-[2px]" onClick={() => scrollToRef(footerRef)}>
      ...
      <div className="signup mt-2">
        {token ? (
          <div className="flex items-center justify-center">
            <button className="border-2 border-green-700 rounded-full hover:bg-green-500 hover:text-white p-1">
              {role === "user" ? (
                <Link to="/customerdb">
                  <img src={contact} alt="" />
                </Link>
            ...
            <button
              onClick={logout}
              className="border-[1px]  border-red-700 px-2 py-1 rounded-full hover:bg-red-500 hover:text-white ml-4"
            >
              logout
            </button>
          </div>
          ...
          <div>
            <Link
              to="/signup"
              className="px-6 py-2 border-1 border-slate-700 bg-purple-300  duration-200 rounded-md hover:rounded-full
             hover:text-white hover:bg-gradient-to-r from-[#760fd6] to-[#ac0e0e]"
            >
              SignUp
            </Link>
          </div>
